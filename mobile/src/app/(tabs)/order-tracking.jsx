      ...
      {showCompleted && (
        ...
        >
          <View style={{ flex: 1, backgroundColor: '#fff' }}>
            ...
            >
              <Text style={{ fontSize: 22, fontFamily: 'Roboto_700Bold' }}>
                Completed Orders
              </Text>
            ...
            <ScrollView contentContainerStyle={{ paddingBottom: 24 }}>
              ...
              {selectedOrder ? (
                <>
                    ...
                    <Text
                      style={[
                        styles.modalValue,
                        {
                          color:
                            statusColors[
                              statusMapping[(selectedOrder.status || '').toLowerCase()] ?? 0
                            ],
                        },
                      ]}
                    >
                      ...
                      selectedOrder.items.map((it, idx) => (
                        <View key={idx} style={styles.modalItemRow}>
                          ...
                          <View style={{ flex: 1, marginLeft: 10 }}>
                            ...
                            {it.size && (
                              <Text style={styles.modalItemSmall}>Size: {it.size}</Text>
                            )}
                          </View>
                  ...
                  {/* Nothing here — NO CANCEL & NO REORDER BUTTONS */}
                </>
              ) : (
